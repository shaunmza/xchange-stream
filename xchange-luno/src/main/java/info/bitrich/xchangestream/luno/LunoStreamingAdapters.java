...
import info.bitrich.xchangestream.luno.dto.LunoOrder;
...
class LunoStreamingAdapters {
    ...
    /*@Nullable
    protected static OrderBook adaptOrderBooks(LunoWebSocketOrderBook orderBook) {
        LunoOrder asksOrdersContainer =
                adaptOrders(orderBook.getAsks(), currencyPair, Order.OrderType.ASK);
        OrdersContainer bidsOrdersContainer =
                adaptOrders(orderBook.getBids(), currencyPair, Order.OrderType.BID);
